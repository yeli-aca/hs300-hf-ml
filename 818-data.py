...
dnn.compile(optimizer=Adam(learning_rate=0.0005), loss='mse')

# 早停策略：验证集 10 个 epoch 不提升就停
...
print("✅ Tuned DNN R²:", r2)
print("📉 Tuned DNN MSE:", mse)
